...
img: /img/DVL-dither/DVL_photo1.jpg
---

<div clas="img_row">
    <img class="col three" src="{{ stie.baseurl }}/img/DVL-dither/DVL_photo1.jpg"/>
</div>
...
<div class="img_row">
	<img class="col one" src="{{ site.baseurl }}/img/DVL-dither/DVL_photo3.jpg" alt="" title="example image"/>
	<img class="col one" src="{{ site.baseurl }}/img/DVL-dither/DVL_photo3.jpg" alt="" title="example image"/>
	<img class="col one" src="{{ site.baseurl }}/img/DVL-dither/DVL_photo4.jpg" alt="" title="example image"/>
</div>
...
<div class="img_row">
	<img class="col two" src="{{ site.baseurl }}/img/DVL-dither/DVL_photo5.jpg" alt="" title="example image"/>
</div>
